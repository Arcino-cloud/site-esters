...
song.addEventListener('error', () => {
  if (playBtn) playBtn.textContent = '⚠ Música não encontrada';
  console.warn('Não consegui carregar assets/musica.mp3. Confira se o arquivo está no GitHub dentro de assets com esse nome.');
});
